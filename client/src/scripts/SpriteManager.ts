...
export class SpriteManager {
  ...
  constructor(private appLoader: Loader, private tilesetPath: string, public tilesetSize: number, private tilesetWidth: number, private tilesetHeight: number){}
    ...
    return new Promise((resolve) => {
      this.appLoader
        ...
        .load(() => {
          ...
          for (let i = 0; i < this.tilesetWidth; i++) {
            for (let j = 0; j < this.tilesetHeight; j++) {
